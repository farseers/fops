...
var route = []webapi.Route{
	...
	{"GET", "/linkTrace/webApiList", linkTraceApp.WebApiList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "requestIp", "searchUrl", "statusCode", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/taskList", linkTraceApp.TaskList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "taskName", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/fScheduleList", linkTraceApp.FScheduleList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "taskName", "taskGroupId", "taskId", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/consumerList", linkTraceApp.ConsumerList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "server", "queueName", "routingKey", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/slowDbList", linkTraceApp.SlowDbList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "dbName", "tableName", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/slowEsList", linkTraceApp.SlowEsList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "indexName", "aliasesName", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/slowEtcdList", linkTraceApp.SlowEtcdList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "key", "leaseID", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/slowHandList", linkTraceApp.SlowHandList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "name", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/slowHttpList", linkTraceApp.SlowHttpList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "method", "url", "requestBody", "responseBody", "statusCode", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/slowMqList", linkTraceApp.SlowMqList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "server", "exchange", "routingKey", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
	{"GET", "/linkTrace/slowRedisList", linkTraceApp.SlowRedisList, "", []context.IFilter{}, []string{"traceId", "appName", "appIp", "key", "field", "searchUseTs", "startMin", "pageSize", "pageIndex", ""}},
