		...
		<el-dialog :title="state.dialog.title" v-model="state.dialog.isShowDialog" width="70%">
            ...
            <ul class="custom-list">
              <li>
                ...
                <el-tag>{{state.ruleForm.Method}} => </el-tag><span> {{state.ruleForm.Url}}</span> <span>整体耗时：{{state.ruleForm.UseDesc}}</span>
              </li>
              <li><el-tag>Headers：</el-tag>{{friendlyJSONstringify(state.ruleForm.Headers)}}</li>
              <li><el-tag>入参：</el-tag>{{state.ruleForm.RequestBody}}</li>
              <li><el-tag>出参：</el-tag>{{state.ruleForm.ResponseBody}}</li>
            </ul>
					</el-col>
				</el-row>
			</el-form>
