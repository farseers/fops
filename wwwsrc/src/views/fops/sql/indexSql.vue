<template>
	<div class="system-user-container layout-padding">
        ...
        <label class="ml10">数据库名称</label>
        <el-input size="default" v-model="state.dbName" placeholder="数据库名称" style="max-width: 180px"> </el-input>
        <label class="ml10">表名称</label>
        <el-input size="default" v-model="state.tableName" placeholder="表名称" style="max-width: 180px"> </el-input>
        ...
        <el-table-column width="100px" prop="DbName" label="数据库名" show-overflow-tooltip></el-table-column>
        <el-table-column width="150px" prop="TableName" label="表名" show-overflow-tooltip></el-table-column>
        <el-table-column width="400px" prop="Sql" label="Sql语句" show-overflow-tooltip></el-table-column>
        <el-table-column prop="ConnectionString" label="连接字符串" ></el-table-column>
...
const getTableData = () => {
  ...
  // 请求接口
  serverApi.slowSql(params).then(function (res){
    if (res.Status){
