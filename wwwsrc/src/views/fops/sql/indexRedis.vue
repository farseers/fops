<template>
	<div class="system-user-container layout-padding">
        ...
        <el-input size="default" v-model="state.key" placeholder="Key" style="max-width: 180px;padding-left: 5px"> </el-input>
        <label class="ml10">Field</label>
        <el-input size="default" v-model="state.field" placeholder="Field" style="max-width: 180px;padding-left: 5px"> </el-input>
