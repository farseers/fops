...
require (
	...
	github.com/farseer-go/linkTrace/driver/clickhouse v0.11.0
...
require (
	...
	github.com/farseer-go/cache v0.11.0 // indirect
	github.com/farseer-go/data/driver/clickhouse v0.11.0 // indirect
	github.com/farseer-go/queue v0.11.0 // indirect
